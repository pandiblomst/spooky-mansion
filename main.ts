...
function start_level () {
    ...
    ghost.setPosition(randint(10, 160), 89)
    ghost.setBounceOnWall(true)
    ghost.setVelocity(20, 20)
    ghost = sprites.create(assets.image`ghost`, SpriteKind.Enemy)
    ghost.setPosition(randint(50, 200), 32)
    ghost.setBounceOnWall(true)
    ghost.setVelocity(20, 20)
    ghost = sprites.create(assets.image`ghost`, SpriteKind.Enemy)
    ghost.setPosition(randint(80, 20), 0)
    ghost.setBounceOnWall(true)
    ghost.setVelocity(30, 30)
    ghost = sprites.create(assets.image`ghost`, SpriteKind.Enemy)
    ghost.setPosition(randint(160, 150), 41)
    ghost.setBounceOnWall(true)
    ghost.setVelocity(20, 20)
}
function startmap2 () {
...
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.chestOpen, function (sprite, location) {
    ...
    game.splash("you find a note!")
    game.splash("\"to future me who is ", "reading this\"")
    game.splash("\"your name is Laura", "and you are in danger!\" ")
    game.splash("\"collect all the keys", "and get the hell out!\"")
    game.splash("\"your life depends on it!\"")
})
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function (sprite, otherSprite) {
    ...
    pause(1000)
    ghost = sprites.create(assets.image`ghost`, SpriteKind.Enemy)
    ghost.setPosition(randint(10, 160), 0)
    ghost.setBounceOnWall(true)
    ghost.setVelocity(40, 40)
})
...
scene.setBackgroundImage(img`
    ...
    `)
game.splash("it is cold", "and dark")
game.splash("you don´t know where", "you are")
game.splash("you don´t know", "who you are")
